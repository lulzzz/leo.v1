...
namespace Leo.Core.Api
{
    /// <summary>
    /// Pulled this from example here... http://stackoverflow.com/questions/17645877/webapi-bind-from-both-uri-and-body
    /// add config.ParameterBindingRules.Insert(0, descriptor => descriptor.ParameterType.IsClass (or some other condition) ? new BodyAndUriParameterBinding(descriptor) : null); to webapiconfig.cs
    /// </summary>
    [ExcludeFromCodeCoverage]
    public class MultiSourceParameterBinding : HttpParameterBinding
    {
        public MultiSourceParameterBinding(HttpParameterDescriptor descriptor)
            : base(descriptor)
        {
