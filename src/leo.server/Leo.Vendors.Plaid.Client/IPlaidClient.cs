...
namespace Leo.Vendors.Plaid.Client
{
    public interface IPlaidClient
    {
        ...
        Task<RetrieveBalancesResponse> RetrieveBalances(string accessToken, CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<GetCategoriesResponse> GetCategories(CancellationToken cancellationToken = default(CancellationToken));

        Task<UpdateWebhookResponse> UpdateWebhook(string accessToken, string webhook, CancellationToken cancellationToken = default(CancellationToken));
    }
}